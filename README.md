# Monster Rancher Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SLUS-00568 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `Monster_Rancher_Recompiled` (`.exe` on Windows).
