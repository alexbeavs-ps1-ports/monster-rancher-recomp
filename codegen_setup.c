...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Monster Rancher",
    .project_root_env = "MONSTER_RANCHER_PROJECT_ROOT",
    .build_dir_env = "MONSTER_RANCHER_BUILD_DIR",
    .force_setup_env = "MONSTER_RANCHER_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_005.68_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Monster_Rancher_Recompiled",
    .prepare_note =
